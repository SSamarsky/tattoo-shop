  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.footer__contact}>
        <div className={styles.contact__phone_and_social}>
        ...
        <p className={styles.contact__info}>Время работы: с 9:00 до 20:00 по мск</p>
        <a className={styles.contact__mail} href="mailto:Mr.Driskell@mail.ru">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="21"
              height="16"
